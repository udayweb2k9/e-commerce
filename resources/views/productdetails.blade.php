                        ...
                        <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <h3>23 Reviews</h3>
                                    <div class="review">
                                        <div class="user-img" style="background-image: url(../../frontend/images/person1.jpg)"></div>
                                        <div class="desc">
                                            <h4>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 text-center">
                <div class="product-entry">
                    <div class="product-img" style="background-image: url(../../frontend/images/item-5.jpg);">
